...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_20px_-3px_hsla(142,100%,50%,0.4)]",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-[0_0_20px_-3px_hsla(0,84%,60%,0.3)]",
        outline:
        ...
        glow:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_20px_-3px_hsla(142,100%,50%,0.3)] hover:shadow-[0_0_30px_-3px_hsla(142,100%,50%,0.5)]",
      },
      size: {
