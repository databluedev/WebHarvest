      ...
      <footer className="border-t border-border/60">
        <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-10 max-w-[1400px] mx-auto py-8 gap-4">
          ...
          <div className="flex items-center gap-8">
            ...
            <a href="https://github.com/Takezo49/DataBlue" target="_blank" rel="noopener noreferrer" className="text-[11px] uppercase tracking-[0.2em] text-muted-foreground/50 hover:text-muted-foreground transition-colors font-mono">GitHub</a>
