...
export default function ScrapperPoolPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="relative fixed top-0 left-0 right-0 z-50 border-b border-border bg-background/95 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between px-6 md:px-10 h-16">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <Link href="/playground" className="text-[12px] uppercase tracking-[0.2em] text-muted-foreground hover:text-foreground transition-colors font-mono">Playground</Link>
            <span className="text-[12px] uppercase tracking-[0.2em] text-foreground border-b border-foreground/40 pb-0.5 font-mono cursor-default">Scrapper Pool</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => setMobileNav(!mobileNav)} className="md:hidden h-10 w-10 grid place-items-center text-foreground/60"><Menu className="h-5 w-5" /></button>
          </div>
        </div>
        {mobileNav && (
          <div className="md:hidden border-t border-border bg-background px-6 py-4 space-y-3">
            ...
            <Link href="/playground" className="block text-[12px] uppercase tracking-[0.2em] text-muted-foreground hover:text-foreground font-mono py-2">Playground</Link>
            <span className="block text-[12px] uppercase tracking-[0.2em] text-foreground font-mono py-2">Scrapper Pool</span>
      ...
      {/* ═══ TICKER ═══ */}
      <div className="mt-16 border-b border-border/30 bg-background overflow-hidden h-8 flex items-center">
      ...
      <main>
        ...
        {/* ── HERO ── */}
        <section className="px-6 md:px-10 pt-16 pb-12 border-b border-border/30">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-0">
              <div>
                ...
                <h1 className="font-display text-[48px] md:text-[72px] leading-[0.9] tracking-[-3px] uppercase mb-6">
                  ...
                  <span className="text-foreground/30">POOL.</span>
                </h1>
                <p className="text-[16px] text-muted-foreground max-w-[500px] leading-[1.8] border-l-2 border-cyan-500/40 pl-6 font-mono">
              ...
              <div className="border border-border w-full lg:w-auto lg:min-w-[280px]">
                <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground px-6 py-3 border-b border-border/30 font-mono">Status</div>
                <div className="px-6 py-4 border-b border-border/30 flex items-center justify-between">
                  <span className="text-[12px] text-muted-foreground font-mono uppercase tracking-[0.1em]">Total APIs</span>
        ...
        <section className="px-6 md:px-10 py-16 relative z-10">
          <div className="max-w-[1400px] mx-auto">
                  ...
                  <button
                    ...
                    className={`group relative px-6 py-3.5 border font-mono text-left transition-all duration-200 ${
                      isSelected
                        ...
                        : "border-border/40 bg-card/50 hover:border-border/60 hover:bg-muted/30"
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      <span className={`text-[14px] font-bold uppercase tracking-[0.05em] transition-colors ${isSelected ? "text-foreground" : "text-muted-foreground group-hover:text-foreground/70"}`}>
                        {cat.label}
                      </span>
                    ...
                    <div className={`text-[10px] uppercase tracking-[0.15em] mt-0.5 transition-colors ${isSelected ? "text-muted-foreground" : "text-muted-foreground/50"}`}>
                      {cat.sublabel}
                    </div>
            ...
            <div className="overflow-hidden">
              {API_CATEGORIES.map((cat) => {
                ...
                return (
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[1px] bg-border/30">
                      {categoryApis.map((scraperApi) => {
                        ...
                        return (
                          <div
                            ...
                            className={`bg-background p-8 group transition-colors relative ${
                              isActive ? "cursor-pointer hover:bg-card/50" : ""
                            } ${isOpen ? "bg-muted/30 border-l-2 border-l-cyan-500" : ""}`}
                          >
                            {/* Status badge */}
                            <div className="absolute top-6 right-6">
                              {isActive ? (
                                ...
                                <span className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground/50 font-mono flex items-center gap-1.5">
                            ...
                            {/* Description */}
                            <p className="text-[13px] text-muted-foreground leading-[1.7] mb-6 font-mono">{scraperApi.description}</p>
                            ...
                            <div className="border-t border-border/30 pt-4 flex items-center justify-between">
                              ...
                              {isActive && (
                                <span className={`text-[10px] uppercase tracking-[0.2em] font-mono flex items-center gap-1.5 ${isOpen ? "text-cyan-400" : "text-muted-foreground group-hover:text-foreground/60"} transition-colors`}>
            ...
            {activePanel === "google-search" && (
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                {/* Panel header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-border/30">
                  ...
                  <button onClick={() => setActivePanel(null)} className="h-8 w-8 grid place-items-center text-muted-foreground hover:text-foreground transition-colors">
                    <X className="h-4 w-4" />
                  </button>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  ...
                  <div className="p-6 space-y-5">
                    <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono mb-4">Request Parameters</div>

                    {/* Query input */}
                    <div>
                      <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Query *</label>
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-cyan-500/40 transition-colors"
                        />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Results</label>
                        <div className="relative">
                          <select
                            value={numResults}
                            onChange={(e) => setNumResults(Number(e.target.value))}
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-cyan-500/40 transition-colors"
                          >
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Language</label>
                        <div className="relative">
                          <select
                            value={language}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Country</label>
                        <div className="relative">
                          <select
                            value={country}
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Time Range</label>
                        <div className="relative">
                          <select
                            value={timeRange}
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className={`h-5 w-9 rounded-full transition-colors relative ${safeSearch ? "bg-cyan-500" : "bg-muted"}`}
                      >
                        <span className={`absolute top-0.5 h-4 w-4 rounded-full bg-foreground transition-transform ${safeSearch ? "left-[18px]" : "left-0.5"}`} />
                      </button>
                      <span className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono">Safe Search</span>
                    </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Response</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                            {result.organic_results?.length || 0} results &middot; {result.time_taken?.toFixed(2)}s
                          </span>
                          <button onClick={handleCopyResult} className="flex items-center gap-1.5 text-[10px] uppercase tracking-[0.15em] text-muted-foreground hover:text-foreground/60 font-mono transition-colors">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          <Search className="h-8 w-8 text-muted-foreground/30 mx-auto mb-3" />
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Enter a query and hit Execute</p>
                        </div>
                      </div>
                    )}

                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          <Loader2 className="h-6 w-6 text-cyan-400 animate-spin mx-auto mb-3" />
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching search results...</p>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="space-y-4">
                        ...
                        {result.featured_snippet && (
                          <div className="border border-violet-500/20 bg-violet-500/5 p-4">
                            ...
                            <p className="text-[13px] text-foreground/70 font-mono leading-relaxed">{result.featured_snippet.content}</p>
                        ...
                        <div className="max-h-[500px] overflow-y-auto space-y-[1px] scrollbar-thin">
                          {result.organic_results?.map((item: any, i: number) => (
                            <div key={i} className="bg-background border border-border/20 p-4 hover:border-border/40 transition-colors">
                              <div className="flex items-start justify-between gap-4">
                                <div className="min-w-0 flex-1">
                                  <div className="flex items-center gap-2 mb-1">
                                    <span className="text-[10px] text-muted-foreground/50 font-mono">#{item.position}</span>
                                  ...
                                  {item.snippet && (
                                    <p className="text-[12px] text-muted-foreground font-mono leading-relaxed">{item.snippet}</p>
                                  )}
                                </div>
                                <a href={item.url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-muted-foreground flex-shrink-0">
                        ...
                        {result.people_also_ask && result.people_also_ask.length > 0 && (
                          <div className="border border-border/30 p-4">
                            <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-mono mb-3">People Also Ask</div>
                            <div className="space-y-2">
                              {result.people_also_ask.map((paa: any, i: number) => (
                                <div key={i} className="text-[12px] text-muted-foreground font-mono pl-3 border-l border-border/30">
                                  {paa.question}
                                </div>
                              ))}
                            </div>
                        ...
                        {result.related_searches && result.related_searches.length > 0 && (
                          <div className="border border-border/30 p-4">
                            <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-mono mb-3">Related Searches</div>
                            <div className="flex flex-wrap gap-2">
                              {result.related_searches.map((rs: any, i: number) => (
                                <button
                                  key={i}
                                  onClick={() => { setQuery(rs.query); }}
                                  className="text-[11px] text-muted-foreground font-mono border border-border/40 px-3 py-1.5 hover:text-cyan-400 hover:border-cyan-500/20 transition-colors"
                                >
                                  {rs.query}
                                </button>
                              ))}
                        ...
                        {/* Raw JSON toggle */}
                        <details className="border border-border/30">
                          <summary className="px-4 py-3 text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-mono cursor-pointer hover:text-muted-foreground transition-colors">
                            Raw JSON Response
                          </summary>
                          <pre className="px-4 pb-4 text-[11px] text-muted-foreground font-mono overflow-x-auto max-h-[400px] overflow-y-auto leading-relaxed">
              ...
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    {/* Query input */}
                    <div>
                      <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Product Search *</label>
                      <div className="relative">
                        <input
                          type="text"
                          value={shopQuery}
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-amber-500/40 transition-colors"
                        />
                        <ShoppingCart className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Sort By</label>
                        <div className="relative">
                          <select
                            value={shopSortBy}
                            onChange={(e) => setShopSortBy(e.target.value)}
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-amber-500/40 transition-colors"
                          >
                    ...
                    {/* Minimum Rating */}
                    <div>
                      <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Minimum Rating</label>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Products</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Search for products to see results</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching product listings...</p>
                        </div>
                      </div>
                    )}
                          ...
                          {result.products?.map((product: any, i: number) => (
                            <div key={i} className="bg-background border border-border/20 p-4 hover:border-border/40 transition-colors">
                              <div className="flex gap-4">
                                {/* Product image */}
                                {product.image_url && (
                                  <div className="flex-shrink-0 h-16 w-16 border border-border/30 bg-card/50 grid place-items-center overflow-hidden">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <div className="flex items-start justify-between gap-2 mb-1">
                                    <div className="min-w-0 flex-1">
                                      <div className="flex items-center gap-2 mb-0.5">
                                        <span className="text-[10px] text-muted-foreground/50 font-mono">#{product.position}</span>
                                        {product.badge && (
                                      ...
                                      <a href={product.url} target="_blank" rel="noopener noreferrer" className="text-[13px] text-foreground/80 font-mono hover:text-amber-400 transition-colors line-clamp-2">
                                        {product.title}
                                      </a>
                                    </div>
                                    <a href={product.url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-muted-foreground flex-shrink-0 mt-1">
                                      <ExternalLink className="h-3.5 w-3.5" />
                                    </a>
                                  </div>
                                  ...
                                  <div className="flex items-center gap-3 mb-1">
                                    ...
                                    {product.original_price && (
                                      <span className="text-[12px] text-muted-foreground/50 font-mono line-through">{product.original_price}</span>
                                    )}
                                  </div>
                                  ...
                                  <div className="flex items-center gap-3 flex-wrap">
                                    {product.merchant && (
                                      <span className="text-[11px] text-muted-foreground font-mono">{product.merchant}</span>
                                    )}
                                    {product.rating != null && (
                                      <span className="text-[11px] text-amber-400/70 font-mono flex items-center gap-1">
                                        ...
                                        {product.review_count != null && (
                                          <span className="text-muted-foreground/50">({product.review_count.toLocaleString()})</span>
                                        )}
                                      </span>
                                    )}
                                    {product.shipping && (
                                      <span className={`text-[10px] font-mono ${product.shipping.toLowerCase().includes("free") ? "text-emerald-400/60" : "text-muted-foreground/50"}`}>
                                        {product.shipping}
                                      </span>
                                    )}
                                  </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {result.related_searches.map((rs: any, i: number) => (
                                <button
                                  ...
                                  className="text-[11px] text-muted-foreground font-mono border border-border/40 px-3 py-1.5 hover:text-amber-400 hover:border-amber-500/20 transition-colors"
                                >
                                  {rs.query}
                                </button>
                              ))}
              ...
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    {/* Search Query */}
                    <div>
                      <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Search Query</label>
                      <div className="relative">
                        <input
                          type="text"
                          value={mapsQuery}
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-emerald-500/40 transition-colors"
                        />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">GPS Coordinates</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Place Type</label>
                        <div className="relative">
                          <select
                            value={mapsType}
                            onChange={(e) => setMapsType(e.target.value)}
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-emerald-500/40 transition-colors"
                          >
                            <option value="">Any</option>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Place ID</label>
                        <input
                          type="text"
                          value={mapsPlaceId}
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">CID / Ludocid</label>
                        <input
                          type="text"
                          value={mapsCid}
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Places</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Search for places to see results</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching places from Google Maps...</p>
                        </div>
                      </div>
                    )}
                              ...
                              <div className="flex gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <div className="flex items-start justify-between gap-2 mb-1">
                                    <div className="min-w-0 flex-1">
                                      <div className="flex items-center gap-2 mb-0.5">
                                        <span className="text-[10px] text-muted-foreground/50 font-mono">#{place.position}</span>
                                        {place.type && (
                                        ...
                                        {place.price_level_text && (
                                          <span className="text-[10px] text-muted-foreground font-mono">{place.price_level_text}</span>
                                        )}
                                      </div>
                                      <a href={place.url} target="_blank" rel="noopener noreferrer" className="text-[13px] text-foreground/80 font-mono hover:text-emerald-400 transition-colors line-clamp-2">
                                        {place.title}
                                      </a>
                                    </div>
                                    <a href={place.url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-muted-foreground flex-shrink-0 mt-1">
                                      <ExternalLink className="h-3.5 w-3.5" />
                                    </a>
                                  </div>
                                    ...
                                    {place.rating != null && (
                                      <span className="text-[11px] text-emerald-400/70 font-mono flex items-center gap-1">
                                        ...
                                        {place.review_count != null && (
                                          <span className="text-muted-foreground/50">({place.review_count.toLocaleString()})</span>
                                        )}
                                      </span>
                                    )}
                                    {place.open_now != null && (
                                  ...
                                  <div className="flex items-center gap-3 flex-wrap">
                                    {place.address && (
                                      <span className="text-[11px] text-muted-foreground font-mono">{place.address}</span>
                                    )}
                                    {place.phone && (
                                      <span className="text-[11px] text-muted-foreground/50 font-mono">{place.phone}</span>
                                    )}
                                  </div>
                                  ...
                                  {place.attributes && place.attributes.length > 0 && (
                                    <div className="flex flex-wrap gap-1 mt-1">
                                      {place.attributes.map((attr: string, j: number) => (
                                        <span key={j} className="text-[9px] text-muted-foreground/50 font-mono border border-border/30 px-1.5 py-0.5">
                                          {attr}
                                        </span>
                                      ))}
                                    </div>
                                  ...
                                  {place.user_reviews && place.user_reviews.length > 0 && (
                                    <div className="mt-2 space-y-1">
                                      {place.user_reviews.slice(0, 2).map((review: any, j: number) => (
                                        <div key={j} className="text-[11px] text-muted-foreground/50 font-mono border-l border-border/30 pl-2">
            ...
            {activePanel === "google-news" && (
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-violet-500/40 transition-colors"
                        />
                        <Newspaper className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-violet-500/40 transition-colors"
                          >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Articles</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Search for news to see results</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching news articles...</p>
                        </div>
                      </div>
                    )}
                          ...
                          {result.articles?.map((article: any, i: number) => (
                            <div key={i} className="bg-background border border-border/20 p-4 hover:border-border/40 transition-colors">
                              <div className="flex gap-4">
                                {/* Thumbnail */}
                                {article.thumbnail && (
                                  <div className="flex-shrink-0 h-16 w-20 border border-border/30 bg-card/50 grid place-items-center overflow-hidden">
                                    {/* eslint-disable-next-line @next/next/no-img-element */}
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                                    <span className="text-[10px] text-muted-foreground/50 font-mono">#{article.position}</span>
                                    {article.source && (
                                  ...
                                  {/* Title */}
                                  <div className="flex items-start justify-between gap-2 mb-1">
                                    <a href={article.url} target="_blank" rel="noopener noreferrer" className="text-[13px] text-foreground/80 font-mono hover:text-violet-400 transition-colors line-clamp-2">
                                      {article.title}
                                    </a>
                                    <a href={article.url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-muted-foreground flex-shrink-0 mt-0.5">
                                      <ExternalLink className="h-3.5 w-3.5" />
                                    </a>
                                  </div>
                                  ...
                                  {/* Source URL */}
                                  {article.source_url && (
                                    <span className="text-[10px] text-muted-foreground/40 font-mono">{article.source_url}</span>
                                  )}
                                </div>
                              </div>
                            </div>
              ...
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  <div className="p-6 space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-pink-500/40 transition-colors"
                        />
                        <Briefcase className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                      </div>
                    </div>

                    <div>
                      <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Location <span className="normal-case tracking-normal text-muted-foreground/50">(Google/Alphabet offices only)</span></label>
                      <div className="relative">
                        <input
                          type="text"
                          value={jobsLocation}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Organization</label>
                        <div className="relative">
                          <select value={jobsCompany} onChange={(e) => setJobsCompany(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-pink-500/40 transition-colors">
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Experience</label>
                        <div className="relative">
                          <select value={jobsLevel} onChange={(e) => setJobsLevel(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-pink-500/40 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Job Type</label>
                        <div className="relative">
                          <select value={jobsType} onChange={(e) => setJobsType(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-pink-500/40 transition-colors">
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Sort By</label>
                        <div className="relative">
                          <select value={jobsSortBy} onChange={(e) => setJobsSortBy(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-pink-500/40 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Results</label>
                        <div className="relative">
                          <select value={jobsNumResults} onChange={(e) => setJobsNumResults(Number(e.target.value))} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-pink-500/40 transition-colors">
                      ...
                      <div className="flex items-end pb-1">
                        <label className="flex items-center gap-3 cursor-pointer">
                          ...
                          />
                          <span className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono">Remote Only</span>
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Job Listings</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Search for jobs to see results</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching job listings...</p>
                        </div>
                      </div>
                    )}
                    ...
                    {result && (
                      <div className="space-y-4">
                        {result.jobs?.length === 0 && (
                          <div className="text-center py-8 border border-border/30 bg-background">
                            <Briefcase className="h-8 w-8 text-muted-foreground/30 mx-auto mb-3" />
                            <p className="text-[13px] text-muted-foreground font-mono mb-2">No jobs found{jobsLocation.trim() ? ` in "${jobsLocation.trim()}"` : ""}</p>
                            {jobsLocation.trim() && (
                              <p className="text-[11px] text-muted-foreground/50 font-mono px-6">
                          ...
                          {result.jobs?.map((job: any, i: number) => (
                            <div key={i} className="bg-background border border-border/20 p-4 hover:border-border/40 transition-colors">
                              <div className="flex items-start justify-between gap-2 mb-2">
                                <div className="min-w-0 flex-1">
                                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                                    <span className="text-[10px] text-muted-foreground/50 font-mono">#{job.position}</span>
                                    ...
                                    {job.experience_level && (
                                      <span className="text-[9px] uppercase tracking-wider text-muted-foreground bg-muted/50 border border-border px-1.5 py-0.5 font-mono">
                                        {job.experience_level}
                                      </span>
                                    )}
                                  </div>
                                  <a href={job.detail_url || job.apply_url} target="_blank" rel="noopener noreferrer" className="text-[13px] text-foreground/80 font-mono hover:text-pink-400 transition-colors line-clamp-2">
                                    {job.title}
                                  </a>
                                </div>
                                <a href={job.apply_url || job.detail_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-muted-foreground flex-shrink-0 mt-0.5">
                                  <ExternalLink className="h-3.5 w-3.5" />
                                </a>
                              </div>
                              <div className="flex items-center gap-2 flex-wrap">
                                {job.locations?.map((loc: any, j: number) => (
                                  <span key={j} className="text-[10px] text-muted-foreground font-mono flex items-center gap-1">
            ...
            {activePanel === "google-images" && (
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  <div className="p-6 space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-rose-500/40 transition-colors"
                        />
                        <Image className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Results</label>
                        <div className="relative">
                          <select value={imagesNumResults} onChange={(e) => setImagesNumResults(Number(e.target.value))} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-rose-500/40 transition-colors">
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Colour</label>
                        <div className="relative">
                          <select value={imagesColour} onChange={(e) => setImagesColour(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-rose-500/40 transition-colors">
                            <option value="">Any</option>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Size</label>
                        <div className="relative">
                          <select value={imagesSize} onChange={(e) => setImagesSize(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-rose-500/40 transition-colors">
                            <option value="">Any</option>
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Type</label>
                        <div className="relative">
                          <select value={imagesType} onChange={(e) => setImagesType(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-rose-500/40 transition-colors">
                            <option value="">Any</option>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Aspect Ratio</label>
                        <div className="relative">
                          <select value={imagesAspect} onChange={(e) => setImagesAspect(e.target.value)} className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-rose-500/40 transition-colors">
                            <option value="">Any</option>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Image Results</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Search for images to see results</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching images...</p>
                        </div>
                      </div>
                    )}
                    ...
                    {result && (
                      <div className="space-y-4">
                        {result.images?.length === 0 && (
                          <div className="text-center py-8 border border-border/30 bg-background">
                            <Image className="h-8 w-8 text-muted-foreground/30 mx-auto mb-3" />
                            <p className="text-[13px] text-muted-foreground font-mono">No images found</p>
                          </div>
                        )}
                        <div className="max-h-[600px] overflow-y-auto space-y-[1px] scrollbar-thin">
                          {result.images?.map((img: any, i: number) => (
                            <div key={i} className="bg-background border border-border/20 p-3 hover:border-border/40 transition-colors">
                              <div className="flex gap-3">
                                ...
                                <div className="min-w-0 flex-1">
                                  <div className="flex items-center gap-2 mb-1">
                                    <span className="text-[10px] text-muted-foreground/50 font-mono">#{img.position}</span>
                                    {img.domain && (
                                    ...
                                    {img.file_size && (
                                      <span className="text-[9px] text-muted-foreground/50 font-mono">{img.file_size}</span>
                                    )}
                                  </div>
                                  <a href={img.url} target="_blank" rel="noopener noreferrer" className="text-[12px] text-foreground/70 font-mono hover:text-rose-400 transition-colors line-clamp-1 block">
                                    {img.title}
                                  </a>
                                  <div className="flex items-center gap-3 mt-1">
                                    {img.image_width && img.image_height && (
                                      <span className="text-[10px] text-muted-foreground/50 font-mono">{img.image_width}×{img.image_height}</span>
                                    )}
                                    {img.site_name && (
                                      <span className="text-[10px] text-muted-foreground/50 font-mono">{img.site_name}</span>
                                    )}
                                  </div>
                                </div>
                                <a href={img.image_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-muted-foreground flex-shrink-0 mt-0.5">
                                  <ExternalLink className="h-3.5 w-3.5" />
                                </a>
                              </div>
                            </div>
              ...
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Origin *</label>
                        <div className="relative">
                          <input
                            type="text"
                            value={flightsOrigin}
                            ...
                            placeholder="MAA"
                            maxLength={3}
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-sky-500/40 transition-colors uppercase"
                          />
                          <Plane className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                        </div>
                      </div>
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Destination *</label>
                        <div className="relative">
                          <input
                            type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Departure Date *</label>
                        <input
                          type="date"
                          value={flightsDeparture}
                          min={new Date().toISOString().split("T")[0]}
                          onChange={(e) => setFlightsDeparture(e.target.value)}
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground focus:outline-none focus:border-sky-500/40 transition-colors [color-scheme:dark]"
                        />
                      </div>
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Return Date</label>
                        <input
                          type="date"
                          value={flightsReturn}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Adults</label>
                        <div className="relative">
                          <select
                            value={flightsAdults}
                            onChange={(e) => setFlightsAdults(Number(e.target.value))}
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-sky-500/40 transition-colors"
                          >
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Cabin Class</label>
                        <div className="relative">
                          <select
                            value={flightsSeat}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Max Stops</label>
                        <div className="relative">
                          <select
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Currency</label>
                        <div className="relative">
                          <select
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-mono">Flight Results</div>
                      {result && (
                        <div className="flex items-center gap-3">
                          <span className="text-[10px] text-muted-foreground font-mono">
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Enter origin, destination & date to search flights</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching flights from Google...</p>
                        </div>
                      </div>
                    )}
                    ...
                    {result && (
                      <div className="space-y-4">
                        {result.flights?.length === 0 && (
                          <div className="text-center py-8 border border-border/30 bg-background">
                            <Plane className="h-8 w-8 text-muted-foreground/30 mx-auto mb-3" />
                            <p className="text-[13px] text-muted-foreground font-mono">No flights found for this route</p>
                          </div>
                        )}
                        ...
                        <div className="max-h-[600px] overflow-y-auto space-y-[1px] scrollbar-thin">
                          {result.flights?.map((flight: any, i: number) => (
                            <a
                              ...
                              className={`block bg-background border p-4 hover:border-border/50 hover:bg-card/50 transition-colors cursor-pointer ${flight.is_best ? "border-sky-500/20" : "border-border/20"}`}
                            >
                              <div className="flex items-start justify-between gap-4">
                                <div className="flex-1 min-w-0">
                                  {/* Airline & flight number */}
                                  <div className="flex items-center gap-2 mb-2">
                                    <span className="text-[10px] text-muted-foreground/50 font-mono">#{flight.position}</span>
                                    {flight.is_best && (
                                    ...
                                    <span className="text-[12px] text-foreground/70 font-mono font-bold">{flight.airline}</span>
                                    {flight.flight_number && (
                                      <span className="text-[10px] text-muted-foreground font-mono">{flight.flight_number}</span>
                                    )}
                                  </div>

                                  {/* Route: times & duration */}
                                  <div className="flex items-center gap-3 mb-1.5">
                                    <span className="text-[14px] font-bold font-mono text-foreground">{flight.departure_time}</span>
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    {flight.aircraft && (
                                      <span className="text-[10px] text-muted-foreground/50 font-mono">{flight.aircraft}</span>
                                    )}
                                    {flight.layover_airports?.length > 0 && (
                                      <span className="text-[10px] text-muted-foreground/50 font-mono">via {flight.layover_airports.join(", ")}</span>
                                    )}
                                  </div>
                                </div>
                                ...
                                <div className="text-right flex-shrink-0">
                                  {flight.price_value ? (
                                    ...
                                    <div className="text-[12px] text-muted-foreground/50 font-mono">—</div>
                                  )}
                                  {flight.emissions && (
                                    <div className="text-[9px] text-muted-foreground/50 font-mono mt-1">{flight.emissions}</div>
                                  )}
                                </div>
                              </div>
                            </a>
              ...
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    {/* Query */}
                    <div>
                      <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Ticker / Query</label>
                      <div className="relative">
                        <input
                          type="text"
                          value={financeQuery}
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-lime-500/40 transition-colors"
                        />
                        <TrendingUp className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                      </div>
                      <p className="text-[10px] text-muted-foreground/50 font-mono mt-1.5">Leave empty for market overview with all indexes, crypto, futures & trends</p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-lime-500/40 transition-colors"
                        >
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Enter a ticker or click to get market overview</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching from Google Finance...</p>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="space-y-4">
                        ...
                        {result.stock && (
                          <div className="border border-border/30 p-4 space-y-2">
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="text-[14px] font-bold font-mono text-foreground">{result.name || result.stock}</div>
                                <div className="text-[11px] text-muted-foreground font-mono">{result.stock}</div>
                              </div>
                              <div className="text-right">
                                <div className="text-[18px] font-bold font-mono text-foreground">{result.price}</div>
                            ...
                            {result.previous_close && (
                              <div className="text-[11px] text-muted-foreground font-mono">Prev close: {result.previous_close}</div>
                            )}
                        ...
                        {result.markets && (
                          <div className="space-y-3">
                            {Object.entries(result.markets).map(([section, stocks]) => (
                              <details key={section} className="border border-border/30">
                                <summary className="px-4 py-3 text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono cursor-pointer hover:text-foreground/60 transition-colors flex items-center justify-between">
                                  <span>{section}</span>
                                  <span className="text-[10px] text-muted-foreground/50">{(stocks as any[]).length} stocks</span>
                                </summary>
                                  ...
                                  {(stocks as any[]).map((s: any, i: number) => (
                                    <div key={i} className="flex items-center justify-between py-1 border-b border-border/20 last:border-0">
                                      <div>
                                        ...
                                        <span className="text-[10px] text-muted-foreground font-mono ml-2">{s.name}</span>
                                      </div>
                                      <div className="flex items-center gap-3">
                                        <span className="text-[11px] font-mono text-foreground/60">{s.price}</span>
                                        {s.price_movement && (
                        ...
                        {result.similar_stocks && result.similar_stocks.length > 0 && (
                          <details className="border border-border/30">
                            <summary className="px-4 py-3 text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono cursor-pointer hover:text-foreground/60 transition-colors flex items-center justify-between">
                              ...
                              <span className="text-[10px] text-muted-foreground/50">{result.similar_stocks.length}</span>
                            </summary>
                            <div className="px-4 pb-3 space-y-1">
                        ...
                        {result.news && result.news.length > 0 && (
                          <details className="border border-border/30">
                            <summary className="px-4 py-3 text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono cursor-pointer hover:text-foreground/60 transition-colors flex items-center justify-between">
                              <span>News</span>
                              <span className="text-[10px] text-muted-foreground/50">{result.news.length} articles</span>
                            </summary>
                            <div className="px-4 pb-3 space-y-2">
                              {result.news.map((article: any, i: number) => (
                                <a key={i} href={article.url} target="_blank" rel="noopener noreferrer" className="block py-2 border-b border-border/20 last:border-0 hover:bg-card/50 transition-colors -mx-1 px-1">
                                  <div className="flex items-start gap-3">
                                    {article.thumbnail && (
                                      <img src={article.thumbnail} alt="" className="w-12 h-12 object-cover flex-shrink-0 border border-border/30" />
                                    )}
                                    <div>
                                      <div className="text-[11px] font-mono text-foreground/70 leading-relaxed">{article.title}</div>
                                      {article.source && (
                                        <div className="text-[10px] text-muted-foreground font-mono mt-0.5">{article.source}</div>
                                      )}
                                    </div>
                                  </div>
                                </a>
                        ...
                        {result.market_trends && (
                          <div className="space-y-3">
                            {Object.entries(result.market_trends).map(([label, stocks]) => (
                              <details key={label} className="border border-border/30">
                                <summary className="px-4 py-3 text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono cursor-pointer hover:text-foreground/60 transition-colors flex items-center justify-between">
                                  <span>{label}</span>
                                  <span className="text-[10px] text-muted-foreground/50">{(stocks as any[]).length} stocks</span>
                                </summary>
              ...
              <div ref={panelRef} className="mt-[1px] border border-border/40 bg-card">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-border/30">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-orange-500/40 transition-colors"
                        />
                        <Package className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/50" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Domain</label>
                        <div className="relative">
                          <select
                            value={amazonDomain}
                            onChange={(e) => setAmazonDomain(e.target.value)}
                            className="w-full bg-background border border-border px-4 py-3 text-[13px] font-mono text-foreground appearance-none focus:outline-none focus:border-orange-500/40 transition-colors"
                          >
                      ...
                      <div>
                        <label className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono mb-2 block">Pages</label>
                        <div className="relative">
                          <select
                            value={amazonPages}
                    ...
                    <div>
                      <label className="flex items-center gap-3 cursor-pointer group">
                        ...
                        <span className="text-[11px] uppercase tracking-[0.15em] text-muted-foreground font-mono group-hover:text-foreground/60 transition-colors">Prime Only</span>
                      </label>
                    </div>
                    ...
                    {!result && !loading && !error && (
                      <div className="h-[400px] border border-dashed border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground/50 font-mono">Search Amazon to see products</p>
                        </div>
                      </div>
                    )}
                    ...
                    {loading && (
                      <div className="h-[400px] border border-border/30 grid place-items-center">
                        <div className="text-center">
                          ...
                          <p className="text-[12px] text-muted-foreground font-mono">Fetching Amazon products...</p>
                        </div>
                      </div>
                    )}
                    ...
                    {result && (
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {result.total_results && (
                            <span className="text-[10px] font-mono border border-border bg-muted/50 text-muted-foreground px-2 py-1">
                              {result.total_results}
                            </span>
                          )}
                        </div>
                              ...
                              <div className="flex gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <div className="min-w-0 flex-1">
                                      <div className="flex items-center gap-2 mb-0.5">
                                        ...
                                        {product.is_sponsored && (
                                          <span className="text-[9px] uppercase tracking-wider text-muted-foreground bg-muted/50 border border-border px-1.5 py-0.5 font-mono">AD</span>
                                        )}
                                        {product.is_prime && (
                                      ...
                                      <a href={product.url} target="_blank" rel="noopener noreferrer" className="text-[12px] font-mono text-foreground/80 hover:text-foreground leading-snug line-clamp-2 transition-colors">
                                        {product.title}
                                        <ExternalLink className="inline h-2.5 w-2.5 ml-1 text-muted-foreground/50" />
                                      </a>
                                    </div>
                                  </div>
                                  ...
                                  <div className="flex items-center gap-4 mt-2">
                                    ...
                                    {product.original_price && (
                                      <span className="text-[11px] font-mono text-muted-foreground line-through">{product.original_price}</span>
                                    )}
                                    {product.discount && (
                                  ...
                                  <div className="flex items-center gap-4 mt-1.5 flex-wrap">
                                    ...
                                    {product.review_count != null && (
                                      <span className="text-[10px] font-mono text-muted-foreground">{product.review_count.toLocaleString()} reviews</span>
                                    )}
                                    <span className="text-[10px] font-mono text-muted-foreground/50">{product.asin}</span>
                                  </div>

                                  {/* Delivery + coupon */}
                                  <div className="flex items-center gap-3 mt-1.5 flex-wrap">
                                    {product.delivery && (
                                      <span className="text-[10px] font-mono text-muted-foreground">{product.delivery}</span>
                                    )}
                                    {product.coupon && (
