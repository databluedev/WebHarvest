...
class TestStartCrawl:
    ...
    @pytest.mark.asyncio
    async def test_start_crawl_dispatches_celery_task(
...
class TestCrawlStatus:
    @pytest.mark.asyncio
    async def test_get_crawl_status(
    ...
    @pytest.mark.asyncio
    async def test_get_crawl_other_users_job(
        self, client: AsyncClient, auth_headers, db_session: AsyncSession
    ):
    ...
    @pytest.mark.asyncio
    async def test_crawl_status_pending(
        self, client: AsyncClient, auth_headers, db_session: AsyncSession, test_user
    ):
